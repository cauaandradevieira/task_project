...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        @if (session('success'))
            <div class="mb-4 p-4 rounded-xl border bg-green-100 border-green-300 text-green-700 text-sm font-medium">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden pe-4 pl-4 mb-4">
            ...
            @foreach ($tarefas as $tarefa)
                <div
                    class="task-card rounded-xl border border-gray-200 p-5 mb-4 shadow-sm smooth-transition {{ $tarefa->custo >= 1000 ? 'bg-red-100' : 'bg-white' }}">
                        ...
                        <div class="flex items-center space-x-2 ml-4">
                            ...
                            @if (!$loop->first)
                                <form action="{{ route('tarefas.trocarPosicao', [$tarefa->id, 'SUBIR']) }}" method="POST">
                                    ...
                                    @method('PUT')
                                    <button
                                        class="bg-blue-50 hover:bg-blue-100 text-blue-600 p-3 rounded-xl transition duration-200">
